  ...
  return (
    <section id="skills" className="py-16">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4">
        {list.map(({icon,label})=> (
          <div key={label} className="p-4 rounded-xl bg-white/5 border border-white/10 flex flex-col items-center gap-2 hover:-translate-y-1 hover:shadow-glow transition">
